...
# Script standalone para depurar carregamento de áudio (não é importado pelo jogo).
# Usa os mesmos caminhos de config.py para conferir se os arquivos existem.
...
print(f"audio/        exists: {os.path.exists(PASTA_SONS)}")
