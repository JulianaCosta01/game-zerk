...
SPRITE_MENU_BG = os.path.join(PASTA_MENU, "menu_bg.png")
...
# Assets de tiles do laboratório (32x32, exceto o tanque, que é 32x64)
...
# Cada letra do LAYOUT_MAPA mapeia para: (nome_sprite, tem_colisao, largura_tiles, altura_tiles)
TILES_DECORATIVOS = {
    'T': ("tanque",          True,  1, 2),
    'C': ("console",         True,  2, 2),
